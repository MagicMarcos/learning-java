...
class Client {
    ...
    private static void passByValue() {
        ...
        System.out.println("Client: after the call, x is " + x); // x does not change!!
        // as a primitive type, the value of x is not a reference! So we pass a COPY of x to instructor
    }
