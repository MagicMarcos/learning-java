...
//import com.entertainment.util.Useful; -- can't be imported
...
class TelevisionClient {
    ...
    public static void main(String[] args) {
        // the com.entertainment.util package is not available to me in this module
        // that's because it's not exposed (exported) in that modules module-info.java
        // Useful.help();
