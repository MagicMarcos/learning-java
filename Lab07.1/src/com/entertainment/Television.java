...
public class Television {
    ...
    public void turnOn() {
        ...
        System.out.println("Turning on your " + getBrand() + " com.entertainment.Television. Volume is set to " + getVolume());
    }

    public void turnOff() {
        System.out.println("Turning off your " + getBrand() + " com.entertainment.Television");
    }
